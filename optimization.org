...
| run                  | state    | git-tag            | results-dir       |
|----------------------+----------+--------------------+-------------------|
| First Serial Run     | CANCELED | first-serial-run   | results/first-run |
| First Parallel Run   | CANCELED | first-parallel-run | results/first-run |
| Parallel Runtime Run | STARTED  | pll-runtime-run    | results/pll-2     |
