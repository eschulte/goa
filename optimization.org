...
you'll see a black screen with something like "640x480" in the middle.
Press "h" then press return, then at the next prompt type "install
vga=normal fb=false" and hit return, at this point you should be good
to go.
